	...
	public partial class EventLogErrorVw
	{
		public string Html
		{
			get
			{
				...
				{
					Assembly a = System.Reflection.Assembly.GetExecutingAssembly();
					return a.CreateInstance("Cf.Data." + EventLogEventCategoryName + "VwXmlRepresenter", false, BindingFlags.CreateInstance, null, new string[1] { EventLogParameters }, System.Globalization.CultureInfo.CurrentCulture, null).ToString();
				}
				catch
				{
					return new UncategorizedXmlRepresenter(EventLogParameters).ToString();
				}
			}
			set
			{
