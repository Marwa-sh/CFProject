$(document).ready(function () {
    ...
    if (ticketType == 'EXTENDED') {
        url = '/AxiosSeries/requesterExtendedTicketF?sysUser=' + sysUser + "&customerId=" + customerId + "&contractNumber=" + contractNumber
                    + "&customerName=" + customerName + "&timeLogged=" + timeLogged + "&resolutionDue=" + resolutionDue + "&eventRef=" + eventRef + "&"
    }
    if (ticketType == 'REJECTED') {
        url = '/AxiosSeries/requesterRejectedTicketF?sysUser=' + sysUser + "&customerId=" + customerId + "&contractNumber=" + contractNumber
                    + "&customerName=" + customerName + "&timeLogged=" + timeLogged + "&resolutionDue=" + resolutionDue + "&eventRef=" + eventRef + "&"
    }
    if (ticketType == 'APPROVED') {
        url = '/AxiosSeries/requesterApprovedTicketF?sysUser=' + sysUser + "&customerId=" + customerId + "&contractNumber=" + contractNumber
                    + "&customerName=" + customerName + "&timeLogged=" + timeLogged + "&resolutionDue=" + resolutionDue + "&eventRef=" + eventRef + "&"
    }
    if (ticketType == 'EXPIERED') {
        url = '/AxiosSeries/requesterExpiredTicketF?sysUser=' + sysUser + "&customerId=" + customerId + "&contractNumber=" + contractNumber
                    + "&customerName=" + customerName + "&timeLogged=" + timeLogged + "&resolutionDue=" + resolutionDue + "&eventRef=" + eventRef + "&"
    }
    ...
    var button = {
        success: {
            ...
            callback: function () {
                ...
                var ticketType = $("#ticketType").val();
                if (ticketType == 'EXTENDED') {
                    url = '/AxiosSeries/requesterExtendedTicket?sysUser=' + sysUser + "&customerId=" + customerId + "&contractNumber=" + contractNumber
                                 + "&customerName=" + customerName + "&timeLogged=" + timeLogged + "&resolutionDue=" + resolutionDue + "&eventRef=" + eventRef + "&Start=0";
                }
                if (ticketType == 'REJECTED') {
                    url = '/AxiosSeries/requesterRejectedTicket?sysUser=' + sysUser + "&customerId=" + customerId + "&contractNumber=" + contractNumber
                                 + "&customerName=" + customerName + "&timeLogged=" + timeLogged + "&resolutionDue=" + resolutionDue + "&eventRef=" + eventRef + "&Start=0";
                }
                if (ticketType == 'APPROVED') {
                    url = '/AxiosSeries/requesterApprovedTicket?sysUser=' + sysUser + "&customerId=" + customerId + "&contractNumber=" + contractNumber
                         + "&customerName=" + customerName + "&timeLogged=" + timeLogged + "&resolutionDue=" + resolutionDue + "&eventRef=" + eventRef + "&Start=0";
                }
                if (ticketType == 'EXPIERED') {
                    url = '/AxiosSeries/requesterExpiredTicket?sysUser=' + sysUser + "&customerId=" + customerId + "&contractNumber=" + contractNumber
                         + "&customerName=" + customerName + "&timeLogged=" + timeLogged + "&resolutionDue=" + resolutionDue + "&eventRef=" + eventRef + "&Start=0";
                }
