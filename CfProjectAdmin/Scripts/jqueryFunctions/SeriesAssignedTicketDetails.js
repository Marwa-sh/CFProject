$(document).ready(function () {
    ...
    $(document).on('click', '#takeOverDetails', function () {
        if ($("#requestStatus").val() == "ASSIGNED") {
            ...
            location.href = '/AxiosSeries/showTakeOverDetails?contractNumber=' + $("#contractNumber").val() + "&ticketId=" + $("#ticketId").val() + "&ticketMetaDataId=" + $("#ticketMetaDataId").val() + "&serviceOfferingName=" + $("#serviceOfferingName").val();
        }
    });
        ...
        success: {
            ...
            callback: function () {
                ...
                if (conNum == "" && custId == "") {
                    ...
                    url = '/AxiosSeries/tabsDetails?contractNumber=' + conNum + "&customerId=" + custId + "&serviceOfferingName=" + $("#serviceOfferingName").val() + "&ticketMetaDataId=" + $("#ticketMetaDataId").val() + "&ticketId=" + $("#ticketId").val() + '&IDType=' + IDType;
                    location.href = url;
                }
            }
        },
        ...
        success: {
            ...
            callback: function () {
                ...
                if (custName == "" && custId == "") {
                    ...
                    url = '/AxiosSeries/checkCustomerReservation?customerName=' + custName + "&customerId=" + custId;
                    $('body').addClass('wait');
                    $.ajax({
                        type: "POST",
                        url: url,
...
function showRemarkDialog() {
    ...
    var box = bootbox.dialog({
        ...
        message: 'Remark :<br/> <textarea id="remarkTextArea" name = "remarkTextArea">' + $("#remark").val() + '</textarea><br/>',
        buttons: button
    });
}
