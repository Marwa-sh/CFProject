$(window).load(function () {
    ...
    url = '/AxiosSeries/getAssignedTicketF?sysUser=' + sysUser + "&requesterGroup=" + reqGroup + "&customerId=" + customerId + "&contractNumber=" + contractNumber
    ...
    var button = {
        success: {
            ...
            callback: function () {
                ...
                url = '/AxiosSeries/getAssignedTicket?sysUser=' + sysUser + "&requesterGroup=" + reqGroup + "&customerId=" + customerId + "&contractNumber=" + contractNumber
