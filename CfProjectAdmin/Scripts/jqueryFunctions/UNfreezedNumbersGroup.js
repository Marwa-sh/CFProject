$(window).load(function () {
    ...
    $().loadMore({
        ...
        auto: false,
        url: "/FreezedNumbers/groupUNfreezedNumbersF?" + url,
    });
    ...
    $(document).on('click', '#freezeSelectedGroup', function (e) {
        ...
        if (count == 0) {
            ...
            $.msgBox({
                title: 'Freeze Groups Of Numbers',
                content: 'Are You Sure you want to freeze ' + count + ' group(s) of numbers? ',
                type: "confirm",
                opacity: 0.5,
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (data) {
                                            if (data == false)
                                                ...
                                                $('body').addClass('wait');
                                                $.ajax({
                                                    url: "/FreezedNumbers/freezeSelectedGroupNumbers?" + searchParam,
                                                    type: "GET",
                                                    ...
                                                    success:
                                                        function (data) {
                                                            if (data.status) {
                                                                ...
                                                                $.msgBox({
                                                                    title: 'WARNING',
                                                                    content: "Freeze groups of numbers have been failed",
                                                                    opacity: 0.5,
                                                                    buttons: [{ value: "OK" }],
                                                                })
                                                            }
